Public Class frmMain
    ...
    Private Sub frmMain_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
        ...
        g.DrawImage(pxLucas.Image, pxLucas.Bounds, srcBounds, GraphicsUnit.Pixel)
    End Sub

    Private Sub LucasMove()
            ...
            Select Case (direction)
                Case "stand"
                    If (facing = "right") Then
                        ...
                        pxLucas.Image = My.Resources.lucas
                    Else
                        If (frameCount / delay >= 4) Then
                            frameCount = 0
                        End If
                        srcBounds = New Rectangle(srcBounds.Width * ((pxLucas.Image.Width / 40 - 1) - (frameCount / delay)), 0, 40, 48)
                        pxLucas.Image = My.Resources.lucas
                        pxLucas.Image.RotateFlip(RotateFlipType.RotateNoneFlipX)
                    End If
                    Equalize(2)
                    pxLucas.Left += speed
                Case "right"
                    ...
                    If (frameCount / delay >= 8) Then
                        frameCount = 0
                    End If
                    srcBounds = New Rectangle(srcBounds.Width * (frameCount / delay), pxLucas.Height, 40, 48)
                    pxLucas.Image = My.Resources.lucas
                    pxLucas.Left += speed
                Case "left"
                    If (speed > -maxSpeed) Then
                    ...
                    If (frameCount / delay >= 8) Then
                        frameCount = 0
                    End If
                    srcBounds = New Rectangle(srcBounds.Width * ((pxLucas.Image.Width / 40 - 1) - (frameCount / delay)), pxLucas.Height, 40, 48)
                    pxLucas.Image = My.Resources.lucas
                    pxLucas.Image.RotateFlip(RotateFlipType.RotateNoneFlipX)
                    pxLucas.Left += speed
                Case "up"
